  ...
  return (
    <div className="biz-page" style={{ maxWidth: 1100 }}>
      ...
      <Link href="/business/dashboard/ads" style={{
        display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20,
        marginBottom: 28, padding: "20px 24px", borderRadius: 16, textDecoration: "none",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            <p style={{ fontSize: 15, fontWeight: 800, color: "var(--text)", marginBottom: 2 }}>Boostez votre visibilité</p>
            <p style={{ fontSize: 13, color: "var(--text-muted)" }}>Sponsorisez votre marque auprès de milliers de candidats en Suisse.</p>
          </div>
        </div>
      ...
      {/* Profile completeness + share link */}
      <div className="biz-2col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
        ...
        <div style={{ background: "var(--surface2)", border: "1px solid var(--border)", borderRadius: 16, padding: "22px 24px" }}>
          ...
          <p style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 10, lineHeight: 1.5 }}>
            💡 Email, Slack, Teams — les avis sont 100% anonymes pour tes employés.
          </p>
        </div>
      </div>
    </div>
