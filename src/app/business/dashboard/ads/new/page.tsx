    ...
    <div className="page-root">
      ...
      <div className="biz-page" style={{ maxWidth: 780 }}>
        ...
        <p style={{ fontSize: 14, color: "var(--text-muted)", marginBottom: 32 }}>
          Votre annonce sera visible par les utilisateurs de Workie selon votre ciblage.
        </p>
        ...
        <form action={action} style={{ display: "flex", flexDirection: "column", gap: 0 }}>
            ...
            {(["square", "swipe"] as const).map(f => (
              ...
              >
                ...
                <p style={{ fontSize: 15, fontWeight: 800, color: "var(--text)", marginBottom: 4 }}>
                  {f === "square" ? "Carré" : "Swipe"}
                </p>
                <p style={{ fontSize: 12, color: "var(--text-muted)", lineHeight: 1.5 }}>
                  {f === "square"
                    ? "Apparaît dans la grille d'exploration entre les entreprises."
                    : "S'affiche comme une carte plein écran tous les 10 swipes. Format premium."}
                </p>
                {f === "swipe" && (
                  <span style={{ fontSize: 10, fontWeight: 700, padding: "2px 8px", borderRadius: 50, background: "rgba(249,115,22,0.15)", color: "#f97316", marginTop: 6, display: "inline-block" }}>
                    ×1.5 CPM
                  </span>
                )}
              </button>
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <label style={{
              ...
              borderRadius: 10, border: "1.5px dashed var(--border2)", cursor: "pointer",
              background: "var(--surface2)", marginBottom: 10,
            }}>
              <Upload size={16} color="var(--text-muted)" />
              <span style={{ fontSize: 13, color: "var(--text-muted)" }}>
                {imagePreview ? "Changer d'image" : "Uploader une image"}
              </span>
              <input
                type="file"
                name="image_file"
          ...
          <div style={{ marginBottom: 16 }}>
            <label style={{ fontSize: 13, color: "var(--text-muted)", display: "block", marginBottom: 6 }}>
              Description <span className="badge-optional">OPTIONNEL</span>
            </label>
          ...
          <div style={{ marginBottom: 20 }}>
            <label style={{ fontSize: 13, color: "var(--text-muted)", display: "block", marginBottom: 8 }}>
              Cantons <span className="badge-optional">Tous si vide</span>
            </label>
              ...
              {CANTONS.map(c => (
                <button
                  ...
                  style={{
                    ...
                    color: selectedCantons.includes(c.code) ? "#f97316" : "var(--text-muted)",
                    transition: "all 0.1s",
                  }}
                >
                  {c.code}
          ...
          <div style={{ marginBottom: 28 }}>
            <label style={{ fontSize: 13, color: "var(--text-muted)", display: "block", marginBottom: 8 }}>
              Secteurs d&apos;audience <span className="badge-optional">Tous si vide</span>
            </label>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
              {SECTORS.map(s => (
                <button
                  ...
                  style={{
                    ...
                    color: selectedSectors.includes(s) ? "#8b5cf6" : "var(--text-muted)",
                    transition: "all 0.1s",
                  }}
                >
                  {s}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 16 }}>
            ...
            <div>
              ...
              <input
                type="range" min={dailyBudget} max={5000} step={10} value={totalBudget}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 28 }}>
            ...
            <div>
              <label style={{ fontSize: 13, color: "var(--text-muted)", display: "block", marginBottom: 6 }}>
                Date de fin <span className="badge-optional">OPTIONNEL</span>
              </label>
          ...
          {/* ── Pricing estimate ── */}
          <div style={{
            background: "linear-gradient(135deg, rgba(139,92,246,0.07), rgba(249,115,22,0.05))",
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            ...
            <Link href="/business/dashboard/ads" style={{ fontSize: 13, color: "var(--text-muted)", textDecoration: "none" }}>
              Annuler
            </Link>
          </div>
