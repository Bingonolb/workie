...
import { LayoutDashboard, Star, BarChart3, Briefcase, Settings, Eye, LogOut, Compass, Trophy } from "lucide-react";
...
const EXPLORE_NAV = [
  { href: "/explore", label: "Explorer", icon: <Compass size={17} /> },
  { href: "/ranking", label: "Classement", icon: <Trophy size={17} /> },
];
